...
* Làm quen với IAM và IAM Roles.
* Quản lý database cơ bản với Amazon RDS.
* Thực hành VPC và EC2.
...
* Làm quen và hiểu các kiến thức cơ bản về IAM và IAM Roles
* Cách lưu trữ trên database với Amazon RDS.
* Củng cố kiến thức về VPC và EC2.
